...
Finally, our touchstone: https://www.nexusmods.com/skyrimspecialedition/mods/6194?tab=files[Mod Organizer]. We are just going to install MO in this sub-chapter, taking care about the integration between all the tools in the <<Setting up the environment, next chapter>>.
...
[TIP]
====
Michael, from Gamer Poets, have an excellent four-series list about installing and using MO:

* https://www.youtube.com/watch?v=OHgULB431Os[Installation & Setup]
* https://www.youtube.com/watch?v=us0RHovSguQ[Downloading Mods & Management]
* https://www.youtube.com/watch?v=8Ov9b1Gr6Ho[Profiles, .INI Files, Third Party Applications]
* https://www.youtube.com/watch?v=ooOrSVkhgHc[Toolbar & Customization]
====

. https://www.nexusmods.com/skyrimspecialedition/mods/6194?tab=files[Download] the last version of Mod Organizer using the [NexusFile]*Mod Organizer 1 Legacy* file in the miscellaneous files section (Mod Organizer is outdated, so it is hosted in the Mod Organizer 2 page).
