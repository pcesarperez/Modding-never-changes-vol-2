...
* *https://www.youtube.com/user/gamerpoets[Michael, from GamerPoets]* is a modder and youtuber that I have recently discovered through Gopher's series about Mod Organizer. He has *A FUCKIN' LOT* of tutorials about modding, all of them very thorough and detailed. I have used several resources from GamerPoets, like https://www.youtube.com/watch?v=CqFCLrYn30c[a guide about LOOT], a https://www.youtube.com/watch?v=2F19Do8HAl4[guide about xEdit] and a https://www.youtube.com/watch?v=OHgULB431Os[guide about Mod Organizer].
* *https://wiki.step-project.com/Main_Page[The people behind S.T.E.P. Project]* have the best guides out there about modding _Skyrim_, and in that context they have published https://wiki.step-project.com/Guide:Mod_Organizer[the official guide for Mod Organizer].
* Kelmych has written https://wiki.step-project.com/User:Kelmych/Fallout3[_Clear and Present Danger_], *THE GUIDE* about modding _Fallout 3_. This guide has been on my bedside table for weeks, and its detailed explanations are invaluable.
* My last addition is the incredible https://www.nexusmods.com/fallout3/mods/23468[Fallout 3 Overhaul Modding Guide], created by Markie. I have borrowed a lot of ideas from this guide (which, in turn, relies on Kelmych's guide, among other resources, thus closing the loop).
