...
This guide is subject to a image:https://i.creativecommons.org/l/by-sa/4.0/80x15.png[Creative Commons Attribution Share Alike 4.0] https://creativecommons.org/licenses/by-sa/4.0/[Creative Commons Attribution Share Alike 4.0].
...
. The inner structure shows several files which, but we just need three of them. Deactivate the following files and click on *Ok*.
* `PAL - BASE File.esp`
