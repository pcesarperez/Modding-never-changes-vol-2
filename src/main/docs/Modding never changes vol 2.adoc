...
. UIO is silently installed at the bottom of the left pane. Move it above the two disabled DEFCON 01 patches and activate it (this should be your link:load_order/DEFCON-02-1-stacking-order-after-UIO.txt[stacking order]).
+
